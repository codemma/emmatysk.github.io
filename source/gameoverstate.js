...
gameOverState.create = function () {
    ...
    this.gameOver = this.add.sprite(this.game.width * 0.5, this.game.height * 0.5, 'game_over');
    this.gameOver.anchor.setTo(0.5, 0.5);
    game.add.tween(this.gameOver).to( { alpha: 1 }, 2000, Phaser.Easing.Linear.None, true, 0, 1500, true);
   
    this.button = game.add.button(this.game.width * 0.5, this.game.height * 0.6, 'button', actionOnClick, this, 2, 1, 0);
